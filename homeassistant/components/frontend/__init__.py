...
MANIFEST_JSON = Manifest(
    {
        ...
        "description": (
            "AgentBaba Home automation platform that puts local control and privacy first."
        ),
        "dir": "ltr",
        "display": "standalone",
        "icons": [
        ...
        "lang": "en-US",
        "name": "AgentBaba Home Assistant",
        "short_name": "AgentBaba Home Assistant",
...
def _frontend_root(dev_repo_path: str | None) -> pathlib.Path:
    ...
    # Always return ~/ha-frontend/hass_frontend
    return Path(os.path.expanduser("~/ha-frontend/hass_frontend"))
